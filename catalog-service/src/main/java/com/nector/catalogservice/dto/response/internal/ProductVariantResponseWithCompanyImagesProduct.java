...
@JsonPropertyOrder({ "productVariantId", "skuCode", "variantName", "color", "size", "customAttributes", "mrp",
		"sellingPrice", "purchasePrice", "serialized", "batchTracked", "expiryTracked", "active", "images", "company", "product" })
@Setter
@Getter
@AllArgsConstructor
@NoArgsConstructor
public class ProductVariantResponseWithCompanyImagesProduct {
